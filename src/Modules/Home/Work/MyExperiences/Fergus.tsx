    ...
    sections: [
      {
        ...
        paragraphs: [
          <p>
            Les Mills International has grown from a small family-owned gym to a
            globally recognised brand with a presence in countries all around
            the world.
          </p>,
          <p>
            Les Mills hoped to boost acquisition, retention and referral numbers
            by creating Les Mills Connect, a one-stop digital platform to
            support Les Mills clubs and instructors around the world.
          </p>,
        ],
      },
      {
        ...
        paragraphs: [
          <>
            ...
            <p>
              I worked alongside designers, product managers, quality assurance
              and other software engineers to collaboratively create and improve
              Connect to be a product that we're all proud of.
            </p>
          </>,
          <>
            <p className=" mb-4">
