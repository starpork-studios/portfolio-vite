    ...
    sections: [
      {
        ...
        paragraphs: [
          <p>
            ...
            simulations but their most popular is MikesBikes. A simulation where
            students control their own bike manufacturing company which they use
            to compete in a multiplayer environment against their peers. Their
            goal, to achieve the highest market shareholder value they can.
          </p>,
          <>
            <p className=" mb-4">
              These simulations were built a over 10 years ago so naturally the
              product aged.
            </p>
            <p>
              While the majority of core foundations are just as relevant today
              as they were back then, the user experience was in need of some
              modernisation.
            </p>
          </>,
        ],
      },
      {
        ...
        paragraphs: [
          <>
            ...
            <p>
              While I worked both on backend and frontend my main responsibility
              was the new product.
            </p>
          </>,
          <>
      ...
      },
      {
        ...
        paragraphs: [
          ...
          <div>
            <p>
              Smartsims business simulations are used by universities worldwide
            </p>
